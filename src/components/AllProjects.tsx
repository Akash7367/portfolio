...
const allProjects: Project[] = [
  ...
  },
  {
    ...
    Live_Link: 'https://portfolio-c2xg.vercel.app/?_vercel_share=v9vu4mbb0xIGMIHlCjfjGlcQPbiusSj5',
    updated: '3 days ago',
  },
  {
    name: 'Business Sales Performance Dashboard',
    description: "What's the best way to uncover hidden insights in 38+ Megabytes of raw retail sales data? Build an interactive tool to let the data speak for itself. 📊 During my Data Science internship with Future Interns, I took on the challenge of building a Business Analytics dashboard. I didn't just want to find out the top-selling products; I wanted to create a modular, scalable app that anyone could use to intuitively explore the data. I used Python, Pandas, and Plotly to handle the heavy lifting and connected it all using Streamlit. One of the coolest features I implemented was a dynamic currency logic algorithm that automatically updates all metrics (Pounds, Euros, Dollars) depending on which geographical region you filter by!",
    language: 'Python',
    category: 'Data Science',
    icon: <BarChart size={24} />,
    color: 'from-green-500 to-emerald-500',
    github: 'https://github.com/Akash7367/FUTURE_DS_01',
    Live_Link: 'https://futureds01-wpetekqhvjxbedmxrcen5q.streamlit.app/',
    updated: 'Last week',
  },
  {
    name: 'MLOps Task',
  ...
  },
  {
    ...
    github: 'https://github.com/Akash7367/FUTURE_DS_02',
    updated: '3 weeks ago',
  },
  {
                ...
                <div className="flex flex-wrap items-center gap-6 mt-auto">
                  {project.github && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`inline-flex items-center gap-2 text-sm font-medium transition-all duration-200 relative z-10 ${darkMode
