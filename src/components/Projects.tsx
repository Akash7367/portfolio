...
import { ExternalLink, Code2, Camera, ArrowRight, Bot, Database, Globe } from 'lucide-react';
...
const featuredProjects = [
  {
    ...
    tech: ['React', 'FastAPI', 'Python', 'LLMs', 'LangChain'],
    icon: <Bot size={28} />,
    color: 'from-orange-500 to-amber-500',
    github: 'https://github.com/Akash7367/AI_Teachar',
    liveLink: 'https://ai-teaher-is62.vercel.app/',
    category: 'AI/LLM',
  },
  {
